...
class Logic():
    ...
    def get_gui_data(self):
        self.gui_info = {"requirement": self.round_requirement, "total": self.total,"hands": self.max_hands,"money": self.money, "played": self.played, "shop_dice": self.items_in_shop, "dice": self.dice, "round": self.round}
